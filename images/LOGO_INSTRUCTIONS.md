...
1. Place your a logo file in this `images/` folder
2. Name it exactly: `a-logo.png`
3. Supported formats: `.png`, `.jpg`, `.svg`

### Option 2: Check File Path
The logo path in all HTML files is: `images/a-logo.png`
...
- `./images/a-logo.png` (current directory)
- `/images/a-logo.png` (root directory)

### Fallback
If no logo file is found, the system will automatically show "a" text as a fallback.
